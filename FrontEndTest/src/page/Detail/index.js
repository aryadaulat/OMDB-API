    ...
    return (
      <SafeAreaView style={styles.page}>
        <SafeAreaView style={styles.DetailView}>
          <ScrollView >
            <Image source={{uri:this.state.datatampil.Poster}}
						style={styles.poster}
						resizeMode='contain'
						/>
						...
						<SafeAreaView >
							...
							<Text style={styles.textisi}>{this.state.datatampil.Director}</Text>
							</SafeAreaView>
							<SafeAreaView style={styles.kotak}>
							<Text style={styles.textheader}>Writer</Text>
							<Text style={styles.textisi}>{this.state.datatampil.Writer}</Text>
							</SafeAreaView>
							<SafeAreaView  style={styles.kotak}>
								<Text style={styles.textheader}>Cast</Text>
								<Text style={styles.textisi}>{this.state.datatampil.Actors}</Text>
							</SafeAreaView>
							<SafeAreaView  style={styles.kotak}>
								<Text style={styles.textheader}>Genre</Text>
								<Text style={styles.textisi}>{this.state.datatampil.Genre}</Text>
							</SafeAreaView>
							<SafeAreaView  style={styles.kotak}>
								<Text style={styles.textheader}>Language</Text>
								<Text style={styles.textisi}>{this.state.datatampil.Language}</Text>
							</SafeAreaView>
							<SafeAreaView  style={styles.kotak}>
							...
							<SafeAreaView  style={styles.kotak}>
								...
								<Text style={styles.textisi}>{this.state.datatampil.Released}</Text>
							</SafeAreaView>
							<SafeAreaView  style={styles.kotak}>
								<Text style={styles.textheader}>Awards</Text>
								<Text style={styles.textisi}>{this.state.datatampil.Awards}</Text>
							</SafeAreaView>
							<SafeAreaView style={styles.kotak}>
								<Text style={styles.textheader}>Runtime</Text>
								<Text style={styles.textisi}>{this.state.datatampil.Runtime}</Text>
							</SafeAreaView>
							<SafeAreaView style={styles.kotak}>
								<Text style={styles.textheader}>Rated</Text>
								<Text style={styles.textisi}>{this.state.datatampil.Rated}</Text>
							</SafeAreaView>
						</SafeAreaView>
          </ScrollView>
        </SafeAreaView>
